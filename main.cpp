...
class Mariposa : Artropodo {
private:
  string patronAlas;

public: // Acciones
  Mariposa(bool,string,bool, 
  string, int, bool, string, string, 
  bool,
  string); // Constructor
...
/*class caracoles : Moluscos {
public:
  caracoles(string,bool, string, bool, int, bool, string, string, bool, bool, bool);
};

class Ostras : Moluscos {
public:
  Ostras(string,bool, string, bool, int, bool, string, string, bool, bool, bool);
};*/
...
/*class erizoDeMar : Equinodermos {
public:
  erizoDeMar(string,bool, string, bool, int, bool, string, string, bool, bool);
};

class estrellaDeMAr : Equinodermos {
public:
  estrellaDeMAr(string,bool, string, bool, int, bool, string, string, bool, bool);
};*/
